    ...
    def get_default_graph(self):
        ...
        node_dict={
            ...
            "40000011":{
                    ...
                    "layer":4,
                    "node_type":"dynamic",
                    "description_ja":"車椅子のブレーキを解除しています",
                    "node_code_to":["50000100","50000101","50000102","50000103"],
                    },
            "40000012":{
                    "score":np.nan,
