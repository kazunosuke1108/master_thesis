...
class Visualizer(Manager):
    ...
    def object_snapshot(self,data_dict,structure_dict):
        ...
        def closest_object_xy(object_positions):
        ...
        data_dict[50001000],data_dict[50001001]=closest_object_xy(structure_dict["ivPole"])
        ...
        data_dict[50001010],data_dict[50001011]=closest_object_xy(structure_dict["wheelchair"])
